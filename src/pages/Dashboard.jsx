  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-5 sm:py-8">
        ...
        {/* Mobile column tabs */}
        <div
          className="flex md:hidden gap-1 mb-4 bg-gray-100
      ...
      {shareModal && (
        ...
        >
          <div
            className="w-full sm:max-w-sm bg-white dark:bg-gray-800
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <div
                className="w-10 h-10 bg-indigo-100 dark:bg-indigo-900/30
