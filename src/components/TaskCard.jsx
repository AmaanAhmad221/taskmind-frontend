    ...
    >
      ...
      <div className="flex items-center justify-between mb-2.5">
        <div className="flex items-center gap-1.5">
          ...
          <span
            className={`text-xs font-medium px-2 py-0.5 rounded-full ${priority.class}`}
          >
            {priority.label}
          </span>
        </div>
          ...
          {isOverdue && (
            ...
            >
              <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                <path
                  fillRule="evenodd"
                  d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1
                  1 0 00-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0
      ...
      {/* Action buttons — onPointerDown stops drag activation */}
      <div
